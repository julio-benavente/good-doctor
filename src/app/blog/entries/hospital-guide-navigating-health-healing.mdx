export const metadata = {
  title:
    "Navigating the Path to Health and Healing: Your Guide to [Hospital Name]",
  ...
  date: new Date("2025"),
  excerpt:
    "In a world where health is paramount, [Hospital Name] stands as a beacon of hope, offering cutting-edge healthcare services and unwavering support to its patients. Join us on a journey through the corridors of [Hospital Name] as we explore the keys to health and healing.",
  tableOfContents: [
    {
      id: "heading-intro",
      heading: "Introduction to [Hospital Name]",
    },
    {
